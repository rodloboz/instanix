defmodule InstaphoenixWeb.UserControllerTest do
  use InstaphoenixWeb.ConnCase

  alias Instaphoenix.Accounts

  @create_attrs %{about: "some about", email: "some email", encrypted_password: "some encrypted_password", full_name: "some full_name", username: "some username"}
