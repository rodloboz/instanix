defmodule InstaphoenixWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: InstaphoenixWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/instaphoenix_web/templates",
        namespace: InstaphoenixWeb
      ...
      def render_shared(template, assigns \\ []) do
        render(InstaphoenixWeb.SharedView, template, assigns)
      end
    end
  end
